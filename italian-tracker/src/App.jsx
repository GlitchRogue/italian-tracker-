...
const weekData = [
  { phase:1, label:"Week 1", focus:"Foundation", dateRange:"May 27 – Jun 2", days:[
    { short:"Articles", detail:"Babbel lesson 1 · Anki 20 words · CBT Ep.1 · OnlineItalianClub articles exercises", target:90 },
    { short:"Gender & plural", detail:"CBT Ep.2 · Anki review · Write 5 sentences · OnlineItalianClub plurals", target:75 },
    { short:"essere present", detail:"Babbel + OnlineItalianClub essere/avere · Anki 20 words", target:90 },
    { short:"lo / gli / le", detail:"CBT Ep.3 · Anki review · Write 5 sentences", target:75 },
    { short:"Articles review", detail:"Babbel lesson 2 · Anki 20 words · CBT Ep.4 · OnlineItalianClub drills", target:90 },
  ...
  { phase:1, label:"Week 2", focus:"Foundation", dateRange:"Jun 3 – Jun 9", days:[
    { short:"avere present", detail:"Babbel · Anki 20 words · OnlineItalianClub verbs", target:90 },
    { short:"-are verbs", detail:"CBT Ep.5 · Anki · Write sentences · OnlineItalianClub -are drills", target:75 },
    { short:"-ere/-ire verbs", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
    { short:"Irregular verbs", detail:"CBT Ep.6 · Anki · Write sentences · OnlineItalianClub irregular", target:75 },
    { short:"Adj. agreement", detail:"Babbel + OnlineItalianClub adj exercises · Anki 20 words", target:90 },
  ...
  { phase:2, label:"Week 3", focus:"Build", dateRange:"Jun 10 – Jun 16", days:[
    { short:"Prepositions", detail:"Babbel · Anki 20 words · OnlineItalianClub prepositions", target:90 },
    { short:"del / della", detail:"CBT Ep.7 · Anki · Write sentences · OnlineItalianClub contractions", target:75 },
    { short:"Numbers + time", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
    { short:"da / in / con / su", detail:"CBT Ep.8 · Anki · Write sentences · OnlineItalianClub drills", target:75 },
    { short:"Prep. review", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
  ...
  { phase:2, label:"Week 4", focus:"Build", dateRange:"Jun 17 – Jun 23", days:[
    { short:"potere/volere/dovere", detail:"Babbel · Anki 20 words · OnlineItalianClub modals", target:90 },
    { short:"Reflexive verbs", detail:"CBT Ep.9 · Anki · OnlineItalianClub reflexive exercises", target:75 },
    { short:"mi / ti / lo / la", detail:"Babbel + OnlineItalianClub pronouns · Anki 20 words", target:90 },
    { short:"Direct obj. pronouns", detail:"CBT Ep.10 · Anki · Write sentences", target:75 },
    { short:"Modal + pronoun", detail:"Babbel + OnlineItalianClub combo drills · Anki 20 words", target:90 },
  ...
  { phase:2, label:"Week 5", focus:"Build", dateRange:"Jun 24 – Jun 30", days:[
    { short:"Passato prossimo", detail:"Babbel · Anki 20 words · OnlineItalianClub passato exercises", target:90 },
    { short:"avere auxiliary", detail:"CBT Ep.11 · Anki · OnlineItalianClub avere drills", target:75 },
    { short:"essere auxiliary", detail:"Babbel + OnlineItalianClub essere drills · Anki 20 words", target:90 },
    { short:"Irregular past", detail:"CBT Ep.12 · Anki · Write sentences · OnlineItalianClub irregular past", target:75 },
    { short:"Past tense review", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
  ...
  { phase:3, label:"Week 6", focus:"Intermediate", dateRange:"Jul 1 – Jul 7", days:[
    { short:"Imperfetto form.", detail:"Babbel · Anki 20 words · OnlineItalianClub imperfetto", target:90 },
    { short:"Imperfetto use", detail:"CBT Ep.13 · Anki · OnlineItalianClub imperfetto use", target:75 },
    { short:"PP vs Imperfetto", detail:"Babbel + OnlineItalianClub contrast · Anki 20 words", target:90 },
    { short:"Contrast drills", detail:"CBT Ep.14 · Anki · Write 10 contrast sentences", target:75 },
    { short:"Past contrast", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
  ...
  { phase:3, label:"Week 7", focus:"Intermediate", dateRange:"Jul 8 – Jul 14", days:[
    { short:"Futuro semplice", detail:"Babbel · Anki 20 words · OnlineItalianClub futuro", target:90 },
    { short:"Indirect pronouns", detail:"CBT Ep.15 · Anki · OnlineItalianClub indirect pronouns", target:75 },
    { short:"Combined pronouns", detail:"Babbel + OnlineItalianClub combo · Anki 20 words", target:90 },
    { short:"glielo drills", detail:"CBT Ep.16 · Anki · Write sentences", target:75 },
    { short:"Future + pronouns", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
  ...
  { phase:3, label:"Week 8", focus:"Intermediate", dateRange:"Jul 15 – Jul 21", days:[
    { short:"Condizionale", detail:"Babbel · Anki 20 words · OnlineItalianClub conditional", target:90 },
    { short:"Imperativo", detail:"CBT Ep.17 · Anki · OnlineItalianClub imperative", target:75 },
    { short:"Comparatives", detail:"Babbel + OnlineItalianClub comparatives · Anki 20 words", target:90 },
    { short:"Superlatives", detail:"CBT Ep.18 · Anki · Write sentences", target:75 },
    { short:"Cond. / imp. review", detail:"Babbel + OnlineItalianClub · Anki 20 words", target:90 },
  ...
  { phase:4, label:"Week 9", focus:"Exam Prep", dateRange:"Jul 22 – Jul 28", days:[
    { short:"Full review", detail:"OnlineItalianClub all sections · Anki all decks", target:90 },
    ...
    { short:"Rest + Anki", detail:"Anki only", target:20, type:"rest" },
  ]},
